...
import Category from '../SearchComponents/Category'
import Home from '../SearchComponents/Home'
import Tag from '../SearchComponents/Tag'
                    ...
                    >
                        <View style={{ flex: 1, backgroundColor: 'white', paddingTop: 20 }}>
                            ...
                            {/* <View style={{ height: 130, marginTop: 20 }}>
                                ...
                                >
                                    <Category imageUri={require('../Images/upalis.jpeg')}
                                        name="Breakfast"
                                    />
                                    <Category imageUri={require('../Images/upalis.jpeg')}
                                        name="Lunch"
                            ...
                            <View style={{ marginTop: 40, paddingHorizontal: 20 }}>
                                ...
                                <View style={{ width: width - 40, height: 200, marginTop: 20 }}>
                                    <Image
                                        ...
                                        source={require('../Images/upalis.jpeg')}
                                    />
...
//             <Card
//             title='HELLO WORLD'
//             image={require('../Images/upalis.jpeg')}>
